import { watch, createVNode, Fragment, mergeProps, toRef, onScopeDispose, ref, computed, shallowRef, createTextVNode, watchEffect, nextTick } from 'vue';
import { c as makeVTextFieldProps, d as useForm, V as VTextField } from './VTextField-BZmvmRfe.mjs';
import { f as forwardRefs } from './forwardRefs-BSTjJZPU.mjs';
import { p as propsFactory, m as makeComponentProps, g as genericComponent, y as useResizeObserver, l as useRender, Q as makeDimensionProps, am as getCurrentInstance, a0 as useDimension, af as useToggleScope, E as convertToUnit, I as IconValue, o as omit, aa as makeTransitionProps, u as useLocale, h as useProxiedModel, ab as wrapInArray, a as VIcon, an as ensureValidVNode, O as VDefaultsProvider, w as useDisplay, al as debounce, i as clamp, ao as matchesSelector } from './server.mjs';
import { m as makeItemsProps, e as VDialogTransition, u as useItems, d as VMenu, V as VList, a as VListItem } from './VMenu-BlUxI1bj.mjs';
