import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, ref, nextTick, watchEffect, provide, inject, capitalize, watch, unref } from 'vue';
import { p as propsFactory, I as IconValue, P as makeBorderProps, m as makeComponentProps, b as makeDensityProps, R as makeElevationProps, W as makeRoundedProps, c as makeSizeProps, d as makeTagProps, e as makeThemeProps, Y as makeVariantProps, g as genericComponent, h as useProxiedModel, u as useLocale, v as useRtl, f as provideTheme, w as useDisplay, C as provideDefaults, y as useResizeObserver, j as createRange, l as useRender, V as VBtn, ar as defineFunctionalComponent, E as convertToUnit, S as makeLoaderProps, a2 as useLoader, B as useBackgroundColor, a7 as LoaderSlot, at as getObjectValueByPath, ag as isOn, aq as keyValues, ap as deepEqual, ab as wrapInArray, au as isEmpty, a as VIcon, ad as EventProp, am as getCurrentInstance, av as getPropertyFromItem, i as clamp, as as consoleError } from './server.mjs';
import { V as VSelect } from './VSelect-CQA9Lotf.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn-BOaF0jaZ.mjs';
import { m as makeVTableProps, V as VTable } from './VTable-DbuYfHKf.mjs';
