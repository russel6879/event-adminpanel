...
import { ssrRenderComponent, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const __nuxt_page_meta$2 = { layout: "blank" };
...
const _routes = [
  {
    ...
    component: () => import('./account-settings-BArKC1jD.mjs').then((m) => m.default || m)
  },
  {
    name: "card-basic",
    path: "/card-basic",
    component: () => import('./card-basic-D5iMhhGf.mjs').then((m) => m.default || m)
  },
  {
    name: "cards",
    path: "/cards",
    component: () => import('./cards-DX4Guvf-.mjs').then((m) => m.default || m)
  },
  {
    name: "category",
    path: "/category",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./category-C12lUXnz.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./dashboard-bNfYuqLs.mjs').then((m) => m.default || m)
  },
  {
    name: "edit-listing-id",
    path: "/edit-listing/:id()",
    component: () => import('./_id_-5BBY2iSh.mjs').then((m) => m.default || m)
  },
  {
    name: "event-list",
    path: "/event-list",
    component: () => import('./event-list-CT4191WL.mjs').then((m) => m.default || m)
  },
  {
    name: "form-layouts",
    path: "/form-layouts",
    component: () => import('./form-layouts-D4KCZT-F.mjs').then((m) => m.default || m)
  },
  {
    name: "icons",
    path: "/icons",
    component: () => import('./icons-D95042qt.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-Bd4yA-yk.mjs').then((m) => m.default || m)
  },
  {
    name: "no-existence",
    path: "/no-existence",
    component: () => import('./no-existence-DQ_xxyS7.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./register-Cm-LX43b.mjs').then((m) => m.default || m)
  },
  {
    name: "tables",
    path: "/tables",
    component: () => import('./tables-BXgDiXKT.mjs').then((m) => m.default || m)
  },
  {
    name: "typography",
    path: "/typography",
    component: () => import('./typography-4A9Ls38O.mjs').then((m) => m.default || m)
  },
  {
    name: "venue",
    path: "/venue",
    meta: __nuxt_page_meta || {},
    component: () => import('./venue-D8GF3Sw0.mjs').then((m) => m.default || m)
  },
  {
    name: "website-setup-general",
    path: "/website-setup/general",
    component: () => import('./general-DEfYB880.mjs').then((m) => m.default || m)
  }
];
...
const index_NoOeBbAe38 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const index_HYtSsfhyFh = /* @__PURE__ */ defineNuxtPlugin(() => {
});
...
const layouts = {
  blank: () => import('./blank-C-PH24sJ.mjs').then((m) => m.default || m),
  "components-default-layout-with-vertical-nav": () => import('./DefaultLayoutWithVerticalNav-DdEHRTQV.mjs').then((m) => m.default || m),
  "components-footer": () => import('./Footer-D0b96xV5.mjs').then((m) => m.default || m),
  "components-nav-items": () => import('./NavItems-Dq2o-QeA.mjs').then((m) => m.default || m),
  "components-navbar-theme-switcher": () => import('./NavbarThemeSwitcher-Bu_1DFfB.mjs').then(function(n) {
    return n.N;
  }).then((m) => m.default || m),
  "components-user-profile": () => import('./UserProfile-ecgS5-pQ.mjs').then((m) => m.default || m),
  default: () => import('./default-BXIQaoV0.mjs').then((m) => m.default || m)
};
...
export { useVariant as $, useDensity as A, useBackgroundColor as B, provideDefaults as C, isObject as D, convertToUnit as E, keys as F, makeGroupItemProps as G, useGroupItem as H, IconValue as I, useNuxtApp as J, useTheme as K, VProgressLinear as L, MaybeTransition as M, breakpoints as N, VDefaultsProvider as O, makeBorderProps as P, makeDimensionProps as Q, makeElevationProps as R, makeLoaderProps as S, makeLocationProps as T, makePositionProps as U, VBtn as V, makeRoundedProps as W, makeRouterProps as X, makeVariantProps as Y, Ripple as Z, useBorder as _, VIcon as a, useDimension as a0, useElevation as a1, useLoader as a2, useLocation as a3, usePosition as a4, useRounded as a5, useLink as a6, LoaderSlot as a7, genOverlays as a8, useSize as a9, eventName as aA, destructComputed as aB, parseAnchor as aC, flipSide as aD, flipAlign as aE, flipCorner as aF, getAxis as aG, refElement as aH, IN_BROWSER as aI, useRouter as aJ, __nuxt_component_0$1 as aK, humanReadableFileSize as aL, useRouter$1 as aM, nuxtLinkDefaults as aN, resolveRouteObject as aO, navigateTo as aP, useRuntimeConfig as aQ, createError as aR, defineNuxtRouteMiddleware as aS, useRoute$1 as aT, pickWithRest as aU, makeTransitionProps as aa, wrapInArray as ab, getCurrentInstanceName as ac, EventProp as ad, consoleWarn as ae, useToggleScope as af, isOn as ag, pick as ah, Intersect as ai, filterInputAttrs as aj, callEvent as ak, debounce as al, getCurrentInstance as am, ensureValidVNode as an, matchesSelector as ao, deepEqual as ap, keyValues as aq, defineFunctionalComponent as ar, consoleError as as, getObjectValueByPath as at, isEmpty as au, getPropertyFromItem as av, defineComponent as aw, deprecate as ax, focusChild as ay, getNextElement as az, makeDensityProps as b, makeSizeProps as c, makeTagProps as d, entry$1 as default, makeThemeProps as e, provideTheme as f, genericComponent as g, useProxiedModel as h, clamp as i, createRange as j, getUid as k, useRender as l, makeComponentProps as m, VImg as n, omit as o, propsFactory as p, makeVBtnProps as q, useTextColor as r, makeDisplayProps as s, makeGroupProps as t, useLocale as u, useRtl as v, useDisplay as w, useGroup as x, useResizeObserver as y, focusableChildren as z };
