...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "a2210d19-7041-4d5d-953a-d26f3e078e4a",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\javascript-version\\.data\\kv"}));
...
const _1u09B6Bv1u = defineNitroPlugin((nitroApp) => {
...
const _lazy_nEi2Rb = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nEi2Rb, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nEi2Rb, lazy: true, middleware: false, method: undefined }
];
